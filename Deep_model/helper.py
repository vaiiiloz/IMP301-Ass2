...
def visualize_sample(*images_np, nrow = 3, size_factor = 10.0):
    ...
    # cv2.imwrite('results\\'+str(current_index)+'.jpg', grid.transpose(1, 2, 0))
    ...
    # plt.savefig('results\\'+str(current_index)+'.png')
    plt.show()
