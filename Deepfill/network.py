...
import Deepfill.network_module as network_module
...
class GatedGenerator(nn.Module):
    def __init__(self, opt):
        ...
        self.context_attention = network_module.ContextualAttention(ksize=3, stride=1, rate=2, fuse_k=3, softmax_scale=10,
                                                     fuse=True)
